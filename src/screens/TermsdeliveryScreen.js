    ...
    return (
        <div className="TermsdeliveryScreen Describe">
            <div className="maxWidth">
                <div className="topTitle">Delivery &amp; Returns</div>
                <div className="topCont">
                   ...
                   <ul className="no-padding"> 
                    ...
                    <ol className="ol1">
                        <li className="li1"><span className="s1">If the Buyer no longer wants the goods or is not satisfied with the goods due to no fault with the product, i.e. does not like colour, style, no longer needs the item etc. and requests a refund the Buyer is subject to a handling fee.</span></li>
                        <li className="li1"><span className="s1"> The handling fee is 20% of the original sale price of the order and will be deducted from the amount refunded back to the Buyer under the condition that the Supplier received the returned item in a resalable condition without any damages or signs of obvious use. </span></li>
                        <li className="li1"><span className="s1">All items that are to be returned to the Seller shall be in the exact same condition as when the item was originally dispatched to the Buyer. All labels and fitting will still be attached and untampered with. </span></li>
                        <li className="li1"><span className="s1">All items received are subject to a quality control check to determine that the item meets the above criteria before refunds/ credits can be issued. </span></li>
                        <li className="li1"><span className="s1">If the Supplier feels that the item is not fit for resale or has been tampered, damaged or used, the Supplier withholds the rights to offer any refund/credit to the Buyer.</span></li>
                        <li className="li1"><span className="s1">The 20% handling fee is exempt if the Buyer notifies the Supplier within a 24 hour time scale from the time of placing the order in dispute.</span></li>
                        <li className="li1"><span className="s1">The Supplier reserves the right to inform the Buyer of the refusal of refund/credit in writing addressed to the address details held on the Suppliers database.</span></li>
                    </ol>
                </div>
            </div>
